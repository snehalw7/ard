    ...
    if($_SERVER['REQUEST_METHOD']=='POST' && isset($_POST['search'])){
      ...
      if($exec_query){
        ...
        if(strcmp($table,"1")==0 || strcmp($table,"4")==0){
          echo "<th>Co-supervisor1</th>";
          echo "<th>Co-supervisor2</th>";
          echo "<th>Co-supervisor3</th>";
        }
        echo "</tr></thead> <tbody>";
